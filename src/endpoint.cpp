...
void Endpoint::print_statistics()
{
    ...
    printf("\n\tReceived messages {");
    printf("\n\t\tCRC error: %u %u%% %lluKBytes", _stat.read.crc_error,
    ...
    printf("\n\t\tHandled: %u %lluKBytes", _stat.read.handled, _stat.read.handled_bytes / 1000);
    printf("\n\t\tTotal: %u", _stat.read.total);
    printf("\n\t}");
    printf("\n\tTransmitted messages {");
    printf("\n\t\tTotal: %u %lluKBytes", _stat.write.total, _stat.write.bytes / 1000);
    printf("\n\t}");
    printf("\n}\n");
}
